...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'chenjinde@decc.cloud',
  ...
  email: 'mailto:formac@vip.qq.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/chenjindes/onedrive-vercel-index-1',
    },
  ],
